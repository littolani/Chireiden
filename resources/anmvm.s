...
; void AnmVm::run() -> run(AnmVm* This)
  ...
  44b4e0:	d9 05 48 79 4a 00    	flds   0x4a7948
  44b4e6:	d9 5c 24 74          	fstps  0x74(%esp)
  44b4ea:	a9 00 00 00 20       	test   $0x20000000,%eax
  44b4ef:	74 08                	je     0x44b4f9
  44b4f1:	d9 e8                	fld1
  44b4f3:	d9 1d 48 79 4a 00    	fstps  0x4a7948
  44b4f9:	0f b7 8f 7c 03 00 00 	movzwl 0x37c(%edi),%ecx
  44b500:	66 85 c9             	test   %cx,%cx
  44b503:	0f 85 aa 00 00 00    	jne    0x44b5b3
  44b509:	8b 9f a8 03 00 00    	mov    0x3a8(%edi),%ebx
  44b50f:	0f bf 43 04          	movswl 0x4(%ebx),%eax
  44b513:	3b 47 60             	cmp    0x60(%edi),%eax
  44b516:	89 5c 24 18          	mov    %ebx,0x18(%esp)
  44b51a:	0f 8f 8e 0d 00 00    	jg     0x44c2ae
  44b520:	0f bf 03             	movswl (%ebx),%eax
  44b523:	40                   	inc    %eax
  44b524:	83 f8 67             	cmp    $0x67,%eax
  44b527:	0f 87 e7 22 00 00    	ja     0x44d814
  44b52d:	ff 24 85 28 e2 44 00 	jmp    *0x44e228(,%eax,4)
  44b534:	8b 4b 0c             	mov    0xc(%ebx),%ecx
  44b537:	51                   	push   %ecx
  44b538:	8d 47 5c             	lea    0x5c(%edi),%eax
  44b53b:	e8 c0 ab fb ff       	call   0x406100
  ...
  44b55e:	e8 9d fe ff ff       	call   0x44b400
  ...
  44b56f:	e8 2c fd ff ff       	call   0x44b2a0
  ...
  44b583:	e8 78 ab fb ff       	call   0x406100
  ...
  44b650:	52                   	push   %edx
  44b651:	e8 aa aa fb ff       	call   0x406100
  ...
  44b6b7:	e8 e4 fb ff ff       	call   0x44b2a0
  ...
  44b6ce:	e8 cd fb ff ff       	call   0x44b2a0
  ...
  44b6ef:	e8 8c f9 ff ff       	call   0x44b080
  ...
  44df72:	e8 59 af 00 00       	call   0x458ed0
